module github.com/perpdex/perpdex-l1
...
require (
	...
	nhooyr.io/websocket v1.8.17 // indirect; indirect (force minimum version since v1.8.6 was yanked upstream)
...
replace (
	...
	// nhooyr.io/websocket v1.8.6 was yanked upstream; force every transitive
	// import to v1.8.17 which is still available.
